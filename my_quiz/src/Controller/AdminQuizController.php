...
class AdminQuizController extends AbstractController
{
    ...
    public function index(QuizRepository $quiz)
    {
         ...
         $quizs = $quiz->findAll();
        return $this->render('admin/admin_quiz/index.html.twig', [
            'quizs' => $quizs
        ]);
    }
    ...
    public function new(Request $request,quiz $quiz=null, ObjectManager $manager)
    {
        ...
        return $this->render('admin/admin_quiz/create_quiz.html.twig', [
    ...
    {
        return $this->render('admin/admin_quiz/show_quiz.html.twig',[
            'quiz' => $quiz
         ]);
    }
  /**
